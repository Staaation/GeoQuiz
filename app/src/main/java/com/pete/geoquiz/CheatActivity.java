...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_IS_TRUE = "com.pete.geoquiz.answer_is_true";
    public static final String EXTRA_ANSWER_SHOWN = "com.pete.geoquiz.answer_shown";
